...
/** 
 * DAO for table "GOODS_DATA_BEAN".
*/
public class GoodsDataBeanDao extends AbstractDao<GoodsDataBean, Void> {

    public static final String TABLENAME = "GOODS_DATA_BEAN";

    /**
     * Properties of entity GoodsDataBean.<br/>
    ...
    public GoodsDataBeanDao(DaoConfig config) {
        super(config);
    }
    
    public GoodsDataBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GOODS_DATA_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"GOODS_DATA_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, GoodsDataBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, GoodsDataBean entity) {
        stmt.clearBindings();
        stmt.bindDouble(1, entity.getBargainPrice());
    ...
    @Override
    public GoodsDataBean readEntity(Cursor cursor, int offset) {
        GoodsDataBean entity = new GoodsDataBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, GoodsDataBean entity, int offset) {
    ...
    @Override
    protected final Void updateKeyAfterInsert(GoodsDataBean entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(GoodsDataBean entity) {
        return null;
    }

    @Override
    public boolean hasKey(GoodsDataBean entity) {
        // TODO
        return false;
    }
